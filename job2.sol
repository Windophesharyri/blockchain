...
contract flatSelling {
    ...
    flatConstructMachination FM = new flatConstructMachination();

    payships[] public payshipsArray;
    constructor() {
        admin = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
        member = msg.sender;
        FM.flatAdder(1, admin, 50);
    }
}

contract flatConstructMachination {
    flatSelling FS = new flatSelling();
    function flatAdder(uint _id, address _owner, uint _square) public {
        require(FS.admin == msg.sender, "No permissions");
...
contract flatMoneyMachination is flatSelling {
...
contract FlatInformation is flatSelling {
